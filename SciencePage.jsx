...
return (
  <>
    ...
    <section style={{ background: 'var(--bm-paper-2)' }} className="bm-section-pad">
      <div style={{ fontFamily: 'var(--font-text)', fontWeight: 700, fontSize: 11, letterSpacing: '0.18em', textTransform: 'uppercase', color: 'rgba(10,10,10,0.4)', marginBottom: 14 }}>References</div>
      <ol style={{ marginTop: 16, paddingLeft: 20, fontFamily: 'var(--font-text)', fontSize: 14, lineHeight: 1.8, color: 'rgba(10,10,10,0.6)', maxWidth: 900 }}>
      ...
      <div style={{ marginTop: 32, paddingTop: 24, borderTop: '1px solid rgba(10,10,10,0.1)', fontFamily: 'var(--font-text)', fontSize: 14, lineHeight: 1.7, color: 'rgba(10,10,10,0.55)', maxWidth: 900 }}>
